...
#--------------------------EJERCICIO -----------------------------
  #(Buscar funciones que parámetros lo hacen en la documentación)
  #Importarlo indicando que "-" y los espacios vacíos son datos perdidos (NA).
...
#--------------------------EJERCICIO------------------------------
  ...
  #¿Alguna más?
  #Probar a poner promo como lógical, luego volver a ponerlo como factor ¿porqué factor?
...
summary(df_store)
  ...
  #borrar filas NA de varibales que tengan pocos
  #ver proporción de Nas en CompetitionOpenSinceMonth
...
#--------------------------EJERCICIO------------------------------------------------------
#Renombrar valores de la variable Assortment a basic, extra y extended según corrresponda
...
df_main_reduced
  #EJERCICIO: Estaría bien redondearlas, ¿Como lo haríamos? ¿Y redondear dejando un decimal?
...
#EJERCICIOS (con ggplot o plotly) ----------------------------------------------------------
